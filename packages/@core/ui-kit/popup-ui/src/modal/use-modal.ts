      ...
      (props: TParentModalProps, { attrs, slots }) => {
        provide(USER_MODAL_INJECT_KEY, {
          extendApi(api: ExtendedModalApi) {
            ...
            // 将 sharedData 的引用也设置到 extendedApi 上，这样 setData 才能正确工作
            // 因为如果 extendedApi 本身没有 sharedData，setData 会在 extendedApi 上创建新属性
            (extendedApi as any).sharedData = (api as any).sharedData;
          },
          options,
          async reCreateModal() {
